                ...
                <div class="modal-body max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.new_workflow">New Workflow</span>
                                <kbd class="kbd">Ctrl + N</kbd>
                            </div>
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.open_workflow">Open Workflow</span>
                                <kbd class="kbd">Ctrl + O</kbd>
                            </div>
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.save_workflow">Save Workflow</span>
                            ...
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.export_workflow">Export Workflow</span>
                                <kbd class="kbd">Ctrl + E</kbd>
                            </div>
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.run_workflow">Run Workflow</span>
                                <div class="flex gap-2">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.delete_node">Delete Selected Node</span>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.toggle_properties">Toggle Properties Panel</span>
                                <kbd class="kbd">Space</kbd>
                            </div>
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.cycle_nodes_forward">Cycle Through Nodes (Forward)</span>
                                <kbd class="kbd">Tab</kbd>
                            </div>
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.cycle_nodes_backward">Cycle Through Nodes (Backward)</span>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between py-2 px-3 bg-dark-800/50 rounded-lg">
                                <span class="text-sm text-dark-300" data-i18n="shortcuts.select_multiple">Select Multiple Nodes</span>
                                <kbd class="kbd">Click + Drag</kbd>
                            </div>
                        </div>
                    </div>
