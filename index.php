                    ...
                    <div id="settings-profile" class="settings-content">
                        <div class="space-y-4">
                            ...
                            <div >
                                ...
                                <input type="tel" id="profile-whatsapp" class="form-input w-full bg-dark-700 cursor-not-allowed"
                                    value="<?= htmlspecialchars($user['whatsapp_phone'] ?? 'Not set') ?>" readonly disabled>
                                <p class="text-xs text-dark-500 mt-1">WhatsApp number cannot be changed. Contact support if needed.</p>
                            </div>
                            ...
                            <button id="btn-save-profile" class="btn-primary w-full"
                                data-i18n="settings.save_profile">Save Profile</button>
                        </div>
                    </div>
